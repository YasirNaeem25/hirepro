...
export default function ServiceCoreGreen({navigation}) {
    ...
    return (
        ...
        <View style={[styles.Page_Main_view, AppColours.Home_screen_module_colours]}>
            ...
            <View style={styles.All_Button_container} >
                ...
                <TouchableOpacity style={[AppColours.Button_style, styles.Style_Mobile] }onPress={()=>navigation.navigate('ServiceSelectMob')}  >
                    <Text style={AppColours.Button_Text}>Mobile App Development</Text>
                    <Icon style={[AppColours.Main_Color_Header_icon, styles.image_Style]} size={19} name="mobile1" />
                    <Icon style={[AppColours.Main_Color_Header_icon, styles.image_tick_style]} size={19} name="checkcircleo" />
                </TouchableOpacity>
