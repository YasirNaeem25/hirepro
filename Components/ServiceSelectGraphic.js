...
export default function ServiceSelectGraphic({ navigation }) {
    return (
        ...
        <View style={[styles.Page_Main_view, AppColours.Home_screen_module_colours]}>
            ...
            <View style={styles.All_Button_container} >
                ...
                <TouchableOpacity style={[AppColours.Button_style, styles.Style_Mobile, AppColours.MainColours]}  >
                ...
                <TouchableOpacity style={[AppColours.Button_style, styles.Style_Graphic, AppColours.MainColours]}
                >
                    <Text style={[AppColours.Button_Text, { color: '#FFFF' }]}>Graphic Designing</Text>
                    <Image style={styles.Image_view}
                        source={require('../Components/src/graphicwhite.png')}>
                    </Image>
                    <Icon style={[AppColours.Main_Color_Header_icon, styles.image_tick_style, { color: '#FFFF' }]} size={19} name="checkcircleo" />
                </TouchableOpacity>
                ...
                <TouchableOpacity style={[AppColours.Button_Proceed_Style, styles.Btn_View]}
                    onPress={() => navigation.navigate('ServiceEachCategory')}>
