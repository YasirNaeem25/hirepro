...
export default function ReactJsModal() {
    return (
            <View style={styles.modalStyle}>
                ...
                <View style={styles.box_view_Text}>
                    ...
                    <TouchableOpacity style=
                        {[styles.box1View, AppColours.MainColours, { top: -16, left: 130 }]}>
                        <Text style={[AppColours.Button_Proceed_Text, styles.box1View_Text_style]}> 2 {'\n'} Year</Text>
                    </TouchableOpacity>
                ...
                <Text style={styles.Text_JsPro}>You are Hiring a <Text style={{ fontWeight: 'bold' }}>React JS</Text>  Pro for </Text>

                <View style={{ top: -105, left: 120 }}>
                    <TouchableOpacity style={[AppColours.Button_Proceed_Style, { width: 130, backgroundColor: '#EFFFFA' }]}>
                        <Text style={[AppColours.Button_Proceed_Text, AppColours.Text_colours]}> $ 8.00</Text>
                    </TouchableOpacity>
                </View>
            </View>
